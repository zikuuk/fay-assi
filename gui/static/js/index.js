new Vue({
    ...
    methods: {
        changeMicrophone(){
            this.source_record_enabled = !this.source_record_enabled;
        },
        openSet() {
            this.onButton = true
        ...
        closeSet() {
            ...
            // document.querySelector(".content").scrollTop = this.contentHeight;
        },
                ...
                if (!executed && xhr.status === 200) {
                    try {
                        if (xhr.responseText.length > 0) {
                            ...
                            _this.rtsp_url = interact["rtspUrl"]
    ...
    mounted() {
        ...
        _this.timer = setInterval(() => {
            setTimeout(_this.reFreshMsgList, 0)
        }, 3000)
